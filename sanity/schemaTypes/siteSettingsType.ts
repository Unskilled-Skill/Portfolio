  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        'available', 'heroLocation', 'metaRole', 'metaStudying', 'metaFocus',
        'workTitle', 'aboutLabel', 'aboutTitle', 'whatIDo', 'contactHeadline',
        'emailLabel', 'footerNote', 'backToTop', 'selectedWork', 'projectsTagline',
        'location', 'moreProjects', 'workWithMe', 'processHeadline', 'galleryLabel',
        'galleryHeadline', 'frames', 'allWork', 'nextProject', 'prevProject',
